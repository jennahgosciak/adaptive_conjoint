...
```
    ...
    ## 6 2024-01-04 2024-01-04 16:39:20
...
```
    ...
    ## Number of observations in data: 1934
    ## Status values in data: IP Address, Spam
    ## Number of observations left in data: 1933
...
```
    ...
    ## Warning in check_consent(.): 1932 respondents in the data
...
```
    ...
    ## Warning in check_completion(.): 1924 respondents in the data
...
```
    ...
    ## Warning in check_commitment(.): 1923 respondents in the data

    ## Warning in check_commitment(.): Dropping 2 survey respondents who did not pass
    ## commitment check 2

    ## Warning in check_commitment(.): 1921 respondents in the data
...
```
    ...
    ## Number of rows in data after dropping duplicate ID: 1918
...
```
    ...
    ##  9 Iterative Batch Phase: Min 1          79
    ## 10 Iterative Batch Phase: Min 2         127
    ## # ℹ 14 more rows
...
```
    ...
    ##   <chr>                             <int>   <dbl>
    ## 1 White                              1397 0.728  
    ## 2 Black or African American           187 0.0975 
    ## 3 Asian                               170 0.0886 
    ## 4 Multiracial                          93 0.0485 
    ## 5 Other                                31 0.0162 
    ## 6 Prefer not to disclose               22 0.0115 
    ## 7 American Indian or Alaskan Native    12 0.00626
    ## 8 Native Hawaiian                       6 0.00313
