...
```
    ...
    ## 5 2024-03-01 2024-03-01 19:07:03
...
df <- df %>%
  ...
  mutate(
    ...
    batch_type = case_when(
      batch_id == 0 ~ "Warmup",
      StartDate_clean <= ymd_hms("2024-03-01-20-10-00") ~ "Iterative Batch Phase: Max",
      TRUE ~ NA_character_
    )
  ) %>%
...
```
    ...
    ## 17 Iterative Batch Phase: Max       17   103
    ## 18 Iterative Batch Phase: Max       18   101
    ## 19 Iterative Batch Phase: Max       19   106
    ## 20 Warmup                            0   166
...
```
    ...
    ## 18 Iterative Batch Phase: Max       17 0.67  0.908 0.978
    ## 19 Iterative Batch Phase: Max       18 0.757 0.908 0.969
    ## 20 Iterative Batch Phase: Max       19 0.691 0.876 0.958
...
```
    ...
    ## Warning in check_hiring_screen(.): Dropping 119 survey respondents who have not
    ## been involved in hiring decisions

    ## Warning in check_hiring_screen(.): 119 survey respondents who have not been
    ...
    ## Warning in check_hiring_screen(.): 2014 respondents in the data
...
```
    ...
    ## Warning in check_commitment(.): 2013 respondents in the data

    ## Warning in check_commitment(.): Dropping 3 survey respondents who did not pass
    ## commitment check 2

    ## Warning in check_commitment(.): 2010 respondents in the data
...
```
    ...
    ## Number of rows in data after dropping duplicate ID: 2008
...
```
    ...
    ##   <chr>                      <ord>   <chr>         <int>
    ## 1 Iterative Batch Phase: Max 1       black_low       798
    ## 2 Iterative Batch Phase: Max 2       black_high      545
    ## 3 Iterative Batch Phase: Max 3       white_low       371
    ## 4 Iterative Batch Phase: Max 4       white_high      140
...
```
    ...
    ## 17 Iterative Batch Phase: Max       17   100
    ## 18 Iterative Batch Phase: Max       18    98
    ## 19 Iterative Batch Phase: Max       19    98
    ## 20 Warmup                            0   154
...
```
    ...
    ## 1 1       black_low       838                418                   420     2
    ## 2 2       black_high      586                284                   302    18
    ## 3 3       white_low       398                185                   213    28
    ## 4 4       white_high      186                 82                   104    22
...
```
    ...
    ## # A tibble: 78 × 8
    ## # Groups:   batch_id, batch_type, context [78]
...
```
    ...
    ## 18       17 Iterative …                  0.7                    0.73       0.26 
    ## 19       18 Iterative …                  0.684                  0.724      0.214
    ## 20       19 Iterative …                  0.704                  0.724      0.235
...
```
    ...
    ##   <chr>                             <int>    <dbl>
    ## 1 White                              1453 0.724   
    ## 2 Black or African American           259 0.129   
    ## 3 Asian                               142 0.0707  
    ## 4 Multiracial                          98 0.0488  
    ## 5 Other                                37 0.0184  
    ## 6 American Indian or Alaskan Native    11 0.00548 
    ## 7 Prefer not to disclose                6 0.00299 
    ## 8 Native Hawaiian                       2 0.000996
