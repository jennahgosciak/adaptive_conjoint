...
```
    ...
    ## 5 2024-03-01 2024-03-01 16:48:23
...
df <- df %>%
  ...
  mutate(
    ...
    batch_type = case_when(
      batch_id == 0 ~ "Warmup",
      StartDate_clean <= ymd_hms("2024-03-01-16-50-00") ~ "Iterative Batch Phase: Max",
      TRUE ~ NA_character_
    )
  ) %>%
...
```
    ...
    ## Warning in check_hiring_screen(.): Dropping 111 survey respondents who have not
    ## been involved in hiring decisions

    ## Warning in check_hiring_screen(.): 111 survey respondents who have not been
    ...
    ## Warning in check_hiring_screen(.): 1916 respondents in the data
...
```
    ...
    ## Warning in check_commitment(.): 1915 respondents in the data

    ## Warning in check_commitment(.): Dropping 3 survey respondents who did not pass
    ## commitment check 2

    ## Warning in check_commitment(.): 1912 respondents in the data
...
```
    ...
    ## Number of rows in data after dropping duplicate ID: 1910
...
```
    ...
    ##   <chr>                      <ord>   <chr>         <int>
    ## 1 Iterative Batch Phase: Max 1       black_low       726
    ## 2 Iterative Batch Phase: Max 2       black_high      526
    ## 3 Iterative Batch Phase: Max 3       white_low       365
    ## 4 Iterative Batch Phase: Max 4       white_high      139
...
```
    ...
    ## 1 1       black_low       766                387                   379     8
    ## 2 2       black_high      567                274                   293    19
    ## 3 3       white_low       392                183                   209    26
    ## 4 4       white_high      185                 81                   104    23
...
```
    ...
    ## # A tibble: 74 × 8
    ## # Groups:   batch_id, batch_type, context [74]
...
```
    ...
    ##   <chr>                             <int>   <dbl>
    ## 1 White                              1389 0.727  
    ## 2 Black or African American           247 0.129  
    ## 3 Asian                               132 0.0691 
    ## 4 Multiracial                          89 0.0466 
    ## 5 Other                                35 0.0183 
    ## 6 American Indian or Alaskan Native    11 0.00576
    ## 7 Prefer not to disclose                5 0.00262
    ## 8 Native Hawaiian                       2 0.00105
