...
```
    ...
    ## 11 2024-03-13 2024-03-13 15:48:28
...
```
    ...
    ## Warning in check_completion(.): 4318 respondents in the data
...
```
    ...
    ## Warning in check_hiring_screen(.): Dropping 252 survey respondents who have not
    ## been involved in hiring decisions

    ## Warning in check_hiring_screen(.): 252 survey respondents who have not been
    ...
    ## Warning in check_hiring_screen(.): 4066 respondents in the data
...
```
    ...
    ## 5 Yes, I will   purpke                                     214 TRUE           20
    ## # ℹ abbreviated name: ¹​`Duration (in seconds)`
    ## # ℹ 1 more variable: batch_type <chr>
...
```
    ...
    ## Warning in check_commitment(.): 4064 respondents in the data

    ## Warning in check_commitment(.): Dropping 5 survey respondents who did not pass
    ## commitment check 2

    ## Warning in check_commitment(.): 4059 respondents in the data
...
```
    ...
    ## Number of rows in data after dropping duplicate ID: 4053
...
```
    ...
    ##  5 Iterative Batch Phase: Min 1       black_low       648
    ##  6 Iterative Batch Phase: Min 2       black_high      290
    ##  7 Iterative Batch Phase: Min 3       white_low       169
    ##  8 Iterative Batch Phase: Min 4       white_high      841
...
```
    ...
    ##  3            1    NA     1    NA    NA    NA    NA    NA    NA 4      
    ##  4            0    NA    NA    NA     0    NA    NA    NA    NA 1      
    ##  5            1    NA    NA    NA    NA    NA    NA     1    NA 1      
    ##  6            0    NA    NA    NA    NA    NA    NA     0    NA 1      
    ##  7            1    NA    NA     1    NA    NA    NA    NA    NA 1      
    ##  8            1    NA    NA    NA     1    NA    NA    NA    NA 2      
    ##  9            0    NA    NA    NA    NA    NA    NA     0    NA 4      
...
```
    ...
    ## 1 1       black_low      1550                765                   785    20
    ## 2 2       black_high      898                451                   447     4
    ## 3 3       white_low       574                280                   294    14
    ## 4 4       white_high     1031                504                   527    23
...
```
    ...
    ## # A tibble: 162 × 8
    ## # Groups:   batch_id, batch_type, context [162]
...
```
    ...
    ##  3       0.363 Candidate 2                         1            1 <NA>   
    ##  4       0.254 Candidate 2                         0            0 <NA>   
    ##  5       0.691 Candidate 1                         1            1 <NA>   
    ##  6       0.367 Candidate 2                         1            0 <NA>   
    ##  7       0.631 Candidate 1                         0            1 <NA>   
    ##  8       0.862 Candidate 1                         1            1 <NA>   
    ##  9       0.442 Candidate 2                         1            0 <NA>   
    ## 10       0.708 Candidate 1                         1            0 <NA>   
    ## # ℹ 4,043 more rows
...
```
    ...
    ##  3       0.363 Candidate 2                         1            1
    ##  4       0.254 Candidate 2                         0            0
    ##  5       0.691 Candidate 1                         1            1
    ##  6       0.367 Candidate 2                         1            0
    ##  7       0.631 Candidate 1                         0            1
    ##  8       0.862 Candidate 1                         1            1
    ##  9       0.442 Candidate 2                         1            0
    ## 10       0.708 Candidate 1                         1            0
    ## # ℹ 4,043 more rows
