...
df <- df %>%
  ...
  mutate(
    ...
    batch_type = case_when(
      ...
      StartDate_clean <= ymd_hms("2024-03-06-16-10-00") ~ "Iterative Batch Phase: Min",
      TRUE ~ NA_character_
    )
  ) %>%
...
```
    ...
    ## #   Manipulation_Q1_3 <chr>, QD2 <ord>, QD2_1_TEXT <dbl>, QD3_1 <chr>,
...
```
    ...
    ## Warning in check_completion(.): Dropping 51 survey respondents who did not
    ## finish

    ## Warning in check_completion(.): 2444 respondents in the data
...
```
    ...
    ## Warning in check_hiring_screen(.): Dropping 142 survey respondents who have not
    ## been involved in hiring decisions

    ## Warning in check_hiring_screen(.): 142 survey respondents who have not been
    ...
    ## Warning in check_hiring_screen(.): 2302 respondents in the data
...
```
    ...
    ## Warning in check_commitment(.): 2301 respondents in the data

    ## Warning in check_commitment(.): Dropping 4 survey respondents who did not pass
    ## commitment check 2

    ## Warning in check_commitment(.): 2297 respondents in the data
...
```
    ...
    ## Number of rows in data after dropping duplicate ID: 2295
...
```
    ...
    ##  5 Iterative Batch Phase: Min 1       black_low        25
    ##  6 Iterative Batch Phase: Min 2       black_high       79
    ##  7 Iterative Batch Phase: Min 3       white_low        15
    ##  8 Iterative Batch Phase: Min 4       white_high       71
...
```
    ...
    ##  4            1    NA    NA    NA     1    NA    NA    NA    NA 2      
    ##  5            0    NA    NA    NA    NA     0    NA    NA    NA 1      
    ##  6            0    NA    NA    NA    NA    NA    NA     0    NA 1      
    ##  7            1    NA    NA    NA    NA    NA    NA     1    NA 1      
    ##  8            0    NA    NA    NA    NA     0    NA    NA    NA 3      
    ##  9            1    NA    NA    NA    NA    NA     1    NA    NA 2      
    ## 10            0    NA    NA    NA    NA    NA     0    NA    NA 2      
    ## # ℹ 2,285 more rows
...
```
    ...
    ## 1 1       black_low       927                465                   462     3
    ## 2 2       black_high      687                337                   350    13
    ## 3 3       white_low       420                198                   222    24
    ## 4 4       white_high      261                122                   139    17
...
```
    ...
    ## # A tibble: 90 × 8
    ## # Groups:   batch_id, batch_type, context [90]
...
```
    ...
    ##  7        4 Iterative …                  0.742                  0.763      0.216
    ##  8        5 Iterative …                  0.742                  0.773      0.186
    ##  9        6 Iterative …                  0.711                  0.773      0.227
    ## 10        7 Iterative …                  0.684                  0.714      0.214
    ## # ℹ 13 more rows
...
```
    ...
    ##  4      0.862  Candidate 1                         1            1 <NA>   
    ##  5      0.504  Candidate 1                         1            0 <NA>   
    ##  6      0.877  Candidate 1                         1            0 <NA>   
    ##  7      0.729  Candidate 1                         0            1 <NA>   
    ##  8      0.0982 Candidate 2                         0            0 <NA>   
    ##  9      0.994  Candidate 1                         1            1 <NA>   
    ## 10      0.225  Candidate 2                         0            0 <NA>   
    ## # ℹ 2,285 more rows
...
```
    ...
    ##  4      0.862  Candidate 1                         1            1
    ##  5      0.504  Candidate 1                         1            0
    ##  6      0.877  Candidate 1                         1            0
    ##  7      0.729  Candidate 1                         0            1
    ##  8      0.0982 Candidate 2                         0            0
    ##  9      0.994  Candidate 1                         1            1
    ## 10      0.225  Candidate 2                         0            0
    ## # ℹ 2,285 more rows
...
```
    ...
    ##   <chr>                             <int>    <dbl>
    ## 1 White                              1660 0.723   
    ## 2 Black or African American           290 0.126   
    ## 3 Asian                               168 0.0732  
    ## 4 Multiracial                         116 0.0505  
    ## 5 Other                                41 0.0179  
    ## 6 American Indian or Alaskan Native    11 0.00479 
    ## 7 Prefer not to disclose                7 0.00305 
    ## 8 Native Hawaiian                       2 0.000871
