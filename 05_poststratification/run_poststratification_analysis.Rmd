...
lm <- glm(formula = chose_younger_candidate ~ female + hispanic_latino + age + race_white
          + race_black + race_aian + race_asian + race_nhpi + race_other, family = "binomial",
          data = df_demo_drop)
...
pred_df <- expand.grid(race = factor(c("Black or African American",
                                   "White", "American Indian or Alaska Native",
                                   "Asian", "Native Hawaiian or Other Pacific Islander",
                                   "Other", "Two or More Races"), 
                                   levels = c("Black or African American",
                                   "White", "American Indian or Alaska Native",
                                   "Asian", "Native Hawaiian or Other Pacific Islander",
                                   "Other", "Two or More Races")),
       female = c(1,0),
...
wgts_clean <- wgts %>% 
  mutate(hispanic_latino = if_else(hispanic == TRUE, 1, 0),
         female = if_else(sex == 'Female', 1, 0),
         race = factor(race_acs, levels = c("Black or African American",
                                   "White", "American Indian or Alaska Native",
                                   "Asian", "Native Hawaiian or Other Pacific Islander",
                                   "Other", "Two or More Races", "Prefer not to disclose"))
  ) %>% 
